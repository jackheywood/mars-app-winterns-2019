...
export default class AboutText {
  constructor() {
    ...
    this[cameraNames.CHEMCAM] = 'Chemistry and Camera Complex';
    this[cameraNames.FHAZ] = 'Front Hazard Avoidance Camera';
    this[cameraNames.MAHLI] = 'Mars Hand Lens Imager';
    this[cameraNames.MARDI] = 'Mars Descent Imager';
    this[cameraNames.MAST] = 'Mast Camera';
    this[cameraNames.MINITES] = 'Miniature Thermal Emission Spectrometer (Mini-TES)';
    this[cameraNames.NAVCAM] = 'Navigation Camera';
    this[cameraNames.PANCAM] = 'Panoramic Camera';
    this[cameraNames.RHAZ] = 'Rear Hazard Avoidance Camera';
  }
}
